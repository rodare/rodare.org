...
function toggleContent102() {
  // Get the DOM reference
  var contentId = document.getElementById("content102");
  // Toggle
  contentId.style.display == "block" ? contentId.style.display = "none" :
contentId.style.display = "block"; window.scrollBy(0, 150);
}

function toggleContent103() {
  // Get the DOM reference
  var contentId = document.getElementById("content103");
  // Toggle
  contentId.style.display == "block" ? contentId.style.display = "none" :
contentId.style.display = "block"; window.scrollBy(0, 150);
}
...
function toggleContent108() {
  // Get the DOM reference
  var contentId = document.getElementById("content108");
  // Toggle
  contentId.style.display == "block" ? contentId.style.display = "none" :
contentId.style.display = "block"; window.scrollBy(0, 150);
}